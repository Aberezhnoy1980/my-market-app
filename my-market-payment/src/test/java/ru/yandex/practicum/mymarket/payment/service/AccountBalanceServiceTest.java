...
class AccountBalanceServiceTest {
	...
	void debitRejectsNonPositiveAmount() {
		AccountBalanceService svc = new AccountBalanceService("1000.00");
		StepVerifier.create(svc.debit(BigDecimal.ZERO))
